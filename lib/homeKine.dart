...
import 'package:kine/Profile/ListClient.dart';
...
class _HomeKineState extends State<HomeKine> {
            ...
            child: GestureDetector(
              onTap: () {
                ...
                Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => const ListeClient()));
              },
              child: Column(
                children: [
                  Container(
  ...
  Widget _buildCard(
    ...
    return recentapp == null
        ...
        :
     FutureBuilder(
        future: AuthService().getInfoUserByID(recentapp?.idpatient),
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              print("recent" + recentapp!.idpatient);
                      ...
                      Row(
                        ...
                        children:  <Widget>[
                          ...
                          Padding(
                            ...
                            child: Text(" de ${ recentapp?.starthour ?? 'N/A'} à ${ recentapp?.endhour ?? 'N/A'}",
                                style: const TextStyle(
                                    fontFamily: 'Varela',
                                    fontSize: 17.0,
                                    fontWeight: FontWeight.bold,
