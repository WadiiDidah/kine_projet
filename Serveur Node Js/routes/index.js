...
router.post('/name',/** passport.authenticate('jwt', { session: false }),*/  actions.lookForName)
...
router.get('/addkine', actions.addNewKine)

//@desc Authenticate a user
//@route POST /authenticate
router.post('/authenticate', actions.authenticate)
router.post('/authenticateKine', actions.authenticateKine)
